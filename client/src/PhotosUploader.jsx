    ...
    <>
      <div className="flex gap-2">
        ...
        <button
          ...
          className="bg-gray-300 grow px-4 rounded-xl"
        >
          Add&nbsp;photo
        </button>
      </div>
      ...
      <div className="mt-2 grid gap-4 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <label className="h-32 file:cursor-pointer flex items-center gap-1 justify-center border bg-transparent rounded-xl p-2 text-2xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
